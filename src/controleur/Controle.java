...
public class Controle implements Global {
	...
	private ChoixEquipe frmChoixEquipe;
	...
	public void evenementVue(JFrame uneFrame, Object info) {
		...
		}else if (uneFrame instanceof ChoixEquipe){	
			evenementChoixEquipe(info);
	...
	private void evenementEntreeJeu(Object info) {
		if ((String)info=="serveur") {
			...
			if ((new ClientSocket((String)info, PORT, this)).isConnexionOk()) {
				...
				this.frmChoixEquipe = new ChoixEquipe(this);
				this.frmChoixEquipe.setVisible(true);
			} 
		}
	}
	
	private void evenementChoixEquipe(Object info) {
		frmChoixEquipe.dispose();
		frmChoixJoueur = new ChoixJoueur(this,(Integer)info);
